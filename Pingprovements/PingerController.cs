...
{
    class PingerController : MonoBehaviour
    {
        /**
         * <summary>
        ...
        public PingerController(PingprovementsConfig Config)
        {
            _config = Config;
        ...
        /**
         * <summary>
         *      If a scene unloads, all the <see cref="PingIndicator"/> instances are invalidated by the game. To save on memory
         *      we also clear out the local list of <see cref="PingIndicator"/>s we carry!
         * </summary>
         */
